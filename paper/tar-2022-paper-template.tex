...
From the results, by comparing the negative change in the non ironic sentiment, we conclude that the most influential token and token pairs are "great" and "Success \textvisiblespace " respectively.
}
